...
![PT_DYNAMIC の p_vaddr が指す領域に Elf64_Dyn の配列があり DT_NULL で終端する](../../images/fig/ja/04-1-pt-dynamic.svg)

題材の `main` の `.dynamic` に、実際のエントリを埋めるとこうなる (抜粋):

![dynamic の各エントリは tag に応じて d_val を整数、d_ptr をアドレスとして持つ](../../images/fig/ja/04-2-dynamic-entries.svg)
...
![DT_NEEDED をたどって libmylib.so と libc.so.6 がそれぞれの base に mmap される](../../images/fig/ja/04-3-mapped-objects.svg)
